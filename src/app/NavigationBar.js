    ...
    return (
        <>
            <div class="flex w-full justify-between items-center content-center py-5 px-5 md:px-20 font-header">
                ...
                <div class='md:flex contents-center rounded-full bg-[#CDCACA]/60 backdrop-blur-sm bg-cover p-5'>
                ...
                <div class='flex md:hidden'>
                    <Image src='/square.svg' alt='hamburger icon' class=' flex md:hidden w-12 h-12 md:w-20 md:h-20' />
                </div>
            </div>
        </>
    )
